...
# フルセット効果を削除
    execute if data storage asset:context this{PrevStack:4} unless data storage asset:context {Stack:4} run function asset:effect/0234.ice_armor/fullset/dis_equip
