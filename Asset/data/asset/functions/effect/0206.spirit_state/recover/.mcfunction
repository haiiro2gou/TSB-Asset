...
# 距離が100m以上なら帰らぬ人になる
    execute if score $5Q.X Temporary matches 1000000.. run function asset:effect/0206.spirit_state/recover/damage
# 100m以下なら前の座標にtpする
    execute if score $5Q.X Temporary matches ..999999 run function asset:effect/0206.spirit_state/recover/teleport
