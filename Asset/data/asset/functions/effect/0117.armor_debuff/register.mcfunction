#> asset:effect/0117.armor_debuff/register
#
#
#
# @within function asset:effect/0117.armor_debuff/_/register
...
# 名前
    data modify storage asset:effect Name set value '{"text":"防御力減少"}'
# 説明文
    data modify storage asset:effect Description set value '{"text":"防具値が1減少する"}'
