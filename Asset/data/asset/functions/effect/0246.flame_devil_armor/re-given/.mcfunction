...
# フルセット効果を付与
    execute unless data storage asset:context this{PrevStack:4} if data storage asset:context {Stack:4} run function asset:effect/0246.flame_devil_armor/fullset/equip
