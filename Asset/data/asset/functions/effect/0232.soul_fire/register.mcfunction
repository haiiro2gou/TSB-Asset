...
# 説明文 (TextComponentString[])
    data modify storage asset:effect Description set value ['{"text":"全てを身に纏ったとき、魂炎による追撃が発生する。"}','{"text":"最大体力 -10%","color":"red"}','{"text":"炎攻撃 +10%","color":"green"}','{"text":"MP回復量 +8%","color":"green"}']
