...
# 取引 腕付きアマスタ 普通のアマスタと取引
    ...
    data modify storage asset:trader Trades[-1].Sell set value {id:"minecraft:armor_stand",Count:1b,tag:{display:{Name:'{"text":"腕付き防具立て","color":"gold","italic":false}'},EntityTag:{ShowArms:1b}}}
