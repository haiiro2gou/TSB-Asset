...
# Modifier (Component[]) (オプション)
    ...
    data modify storage asset:artifact Modifiers append value {Type:"attackMagic",Slot:"chest",Amount:0.05d,Operation:"multiply_base"}
    data modify storage asset:artifact Modifiers append value {Type:"attackFire",Slot:"chest",Amount:0.1d,Operation:"multiply_base"}
    data modify storage asset:artifact Modifiers append value {Type:"attackWater",Slot:"chest",Amount:-0.1d,Operation:"multiply_base"}
    ...
    data modify storage asset:artifact Modifiers append value {Type:"mpRegen",Slot:"chest",Amount:0.02d,Operation:"multiply_base"}
# 扱える神 (string[]) Wikiを参照
