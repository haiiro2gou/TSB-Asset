...
# トリガー (Component[])
    ...
    data modify storage asset:artifact Triggers append value {Trigger:"onKilled",Slot:"legs",MPCost:0,Secret:true}
    data modify storage asset:artifact Triggers append value {Trigger:"onDamage",Slot:"legs",Condition:'{"text":"体力が20%以下"}',MPCost:0,Secret:true,LocalCooldown:50,DisableCooldownMessage:true}
# セットID (int) (オプション)
