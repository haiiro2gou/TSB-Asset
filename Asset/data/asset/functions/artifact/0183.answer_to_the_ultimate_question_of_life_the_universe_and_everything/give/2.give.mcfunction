...
# 神器の名前 (TextComponentString)
    data modify storage asset:artifact Name set value '{"text":"","color":"light_purple","obfuscated":true,"extra":[{"text":"4"},{"text":"生命、宇宙、そして万物についての究極の疑問の答え","color":"dark_purple","obfuscated":false},{"text":"2"}]}'
