...
# particle
    ...
    execute at @e[tag=71.Target] run function asset:artifact/0253.holy_barrier/trigger/3.2.particle_reflect

# ダメージ
    execute as @e[tag=71.Target] run function asset:artifact/0253.holy_barrier/trigger/3.3.damage
