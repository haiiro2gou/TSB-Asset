...
#
#
# @within function asset:artifact/0210.terra_blade/trigger/click/3.main
...
# スケジュールループを開始
    schedule function asset:artifact/0210.terra_blade/trigger/click/sword/sword_schedule 1t replace
