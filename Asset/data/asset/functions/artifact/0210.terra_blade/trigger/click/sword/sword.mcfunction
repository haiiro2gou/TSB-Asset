...
#
#
# @within function asset:artifact/0210.terra_blade/trigger/click/sword/sword_schedule
...
# 射撃攻撃
    ...
    execute if entity @s[scores={5U.Burst=1}] anchored eyes positioned ^ ^ ^ run function asset:artifact/0210.terra_blade/trigger/click/event/summon_shot
