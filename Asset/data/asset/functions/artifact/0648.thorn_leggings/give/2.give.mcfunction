...
# トリガー (Component[])
    ...
    data modify storage asset:artifact Triggers append value {Trigger:"onDamageFromEntity",Slot:"legs",MPCost:0,LocalCooldown:20,AttackInfo:{Damage:75,AttackType:[Physical],ElementType:[None]}}
# セットID (int) (オプション)
