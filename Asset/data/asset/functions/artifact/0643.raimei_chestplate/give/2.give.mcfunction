...
# トリガー (Component[])
    ...
    data modify storage asset:artifact Triggers append value {Trigger:"onAttackByMelee",Slot:"chest",MPCost:0,AttackInfo:{Damage:40,AttackType:[Physical],ElementType:[Thunder]}}
# セットID (int) (オプション)
