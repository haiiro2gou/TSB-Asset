...
# トリガー (Component[])
    ...
    data modify storage asset:artifact Triggers append value {Trigger:"onAttack",Slot:"head",MPCost:0,LocalCooldown:20,AttackInfo:{Damage:70,AttackType:[Physical],ElementType:[Water]}}
# セットID (int) (オプション)
