...
# 演出
    execute unless data storage asset:context id{head:664,chest:665,legs:666,feet:667} positioned ~ ~1.7 ~ facing entity @s eyes rotated ~ 0 run function asset:artifact/0664.soul_fire_armor/trigger/particle
