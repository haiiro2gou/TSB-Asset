...
# トリガー (Component) (オプション)
    ...
    data modify storage asset:artifact Triggers append value {Slot:"head",Trigger:"equipping",MPCost:0,Secret:true}
    data modify storage asset:artifact Triggers append value {Slot:"head",Trigger:"onAttack",AttackInfo:{Damage:"80",AttackType:[Physical],ElementType:[Fire],IsRangeAttack:"never"},MPCost:0,Secret:true,LocalCooldown:20,DisableCooldownMessage:true,DisableMPMessage:true}
# 装備セットID (int) (オプション)
