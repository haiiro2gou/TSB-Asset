...
# 召喚
    summon item_display ^ ^ ^ {Tags:["SP.Entity","SP.Sword"],teleport_duration:1,item:{id:"minecraft:diamond_sword",Count:1b,tag:{CustomModelData:20344}},billboard:vertical,transformation:[-0.7071f,-0.7071f,0.0000f,0.0000f,0.7071f,-0.7071f,0.0000f,0.0000f,0.0000f,0.0000f,1.0000f,0.0000f,0.0000f,0.0000f,0.0000f,1.0000f]}
