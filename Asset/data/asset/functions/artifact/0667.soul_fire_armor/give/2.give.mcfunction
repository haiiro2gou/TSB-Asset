...
# 装備時効果 (Component[]) (オプション)
    ...
    data modify storage asset:artifact Modifiers append value {Type:"maxHealth",Slot:"feet",Amount:-0.10d,Operation:"multiply_base"}
    ...
    data modify storage asset:artifact Modifiers append value {Type:"attackFire",Slot:"feet",Amount:0.10d,Operation:"multiply_base"}
    data modify storage asset:artifact Modifiers append value {Type:"defenseFire",Slot:"feet",Amount:0.10d,Operation:"multiply_base"}
    data modify storage asset:artifact Modifiers append value {Type:"mpRegen",Slot:"feet",Amount:0.08d,Operation:"multiply_base"}
    data modify storage asset:artifact Modifiers append value {Type:"generic.armor",Slot:"feet",Amount:5,Operation:"add"}
    data modify storage asset:artifact Modifiers append value {Type:"generic.armor_toughness",Slot:"feet",Amount:2.5,Operation:"add"}
# 扱える神 (string[]) Wikiを参照
