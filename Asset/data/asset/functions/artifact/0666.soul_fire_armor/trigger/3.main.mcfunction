...
# 演出
    execute unless data storage asset:context id{head:664,chest:665,legs:666,feet:667} positioned ~ ~0.4 ~ facing entity @s eyes rotated ~ 0 run function asset:artifact/0664.soul_fire_armor/trigger/particle
    execute unless data storage asset:context id{head:664,chest:665,legs:666,feet:667} positioned ~ ~0.6 ~ facing entity @s eyes rotated ~ 0 run function asset:artifact/0664.soul_fire_armor/trigger/particle
