...
# Modifiers (Component[]) (オプション)
    ...
    data modify storage asset:artifact Modifiers append value {Type:"attackThunder",Slot:"feet",Amount:0.05d,Operation:"multiply_base"}
    data modify storage asset:artifact Modifiers append value {Type:"defenseThunder",Slot:"feet",Amount:0.1d,Operation:"multiply_base"}
    ...
    data modify storage asset:artifact Modifiers append value {Type:"mpRegen",Slot:"feet",Amount:0.05d,Operation:"multiply_base"}
# 扱える神 (string[]) Wikiを参照
