...
# Modifiers (Component[]) (オプション)
    ...
    data modify storage asset:artifact Modifiers append value {Type:"maxHealth",Slot:"feet",Amount:8,Operation:"add"}
    data modify storage asset:artifact Modifiers append value {Type:"heal",Slot:"feet",Amount:0.06d,Operation:"multiply_base"}
    data modify storage asset:artifact Modifiers append value {Type:"defensePhysical",Slot:"feet",Amount:-0.05d,Operation:"multiply_base"}
# 扱える神 (string[]) Wikiを参照
