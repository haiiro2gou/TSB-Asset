...
# トリガー (Component[])
    ...
    data modify storage asset:artifact Triggers append value {Trigger:"onKilled",Slot:"head",MPCost:0}
    data modify storage asset:artifact Triggers append value {Trigger:"onDamage",Slot:"head",Condition:'{"text":"体力が20%以下"}',MPCost:0,LocalCooldown:50,DisableCooldownMessage:true}
# セットID (int) (オプション)
