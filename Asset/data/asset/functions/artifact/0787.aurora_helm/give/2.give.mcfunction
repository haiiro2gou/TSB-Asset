...
# Modifiers (Component[]) (オプション)
    ...
    data modify storage asset:artifact Modifiers append value {Type:"attackThunder",Slot:"head",Amount:0.05d,Operation:"multiply_base"}
    data modify storage asset:artifact Modifiers append value {Type:"defenseThunder",Slot:"head",Amount:0.1d,Operation:"multiply_base"}
    ...
    data modify storage asset:artifact Modifiers append value {Type:"mpRegen",Slot:"head",Amount:0.05d,Operation:"multiply_base"}
# 扱える神 (string[]) Wikiを参照
