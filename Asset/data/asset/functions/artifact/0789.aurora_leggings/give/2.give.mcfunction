...
# Modifiers (Component[]) (オプション)
    ...
    data modify storage asset:artifact Modifiers append value {Type:"attackThunder",Slot:"legs",Amount:0.05d,Operation:"multiply_base"}
    data modify storage asset:artifact Modifiers append value {Type:"defenseThunder",Slot:"legs",Amount:0.1d,Operation:"multiply_base"}
