...
# Modifiers (Component[]) (オプション)
    ...
    data modify storage asset:artifact Modifiers append value {Type:"attackFire",Slot:"feet",Amount:0.03d,Operation:"multiply_base"}
    data modify storage asset:artifact Modifiers append value {Type:"defenseFire",Slot:"feet",Amount:0.03d,Operation:"multiply_base"}
# 扱える神 (string[]) Wikiを参照
