...
# Modifiers (Component[]) (オプション)
    ...
    data modify storage asset:artifact Modifiers append value {Type:"attackWater",Slot:"head",Amount:0.03d,Operation:"multiply_base"}
    data modify storage asset:artifact Modifiers append value {Type:"defenseWater",Slot:"head",Amount:0.03d,Operation:"multiply_base"}
# 扱える神 (string[]) Wikiを参照
