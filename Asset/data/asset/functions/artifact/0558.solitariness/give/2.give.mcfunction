...
# トリガー (Component[])
    ...
    data modify storage asset:artifact Triggers append value {Trigger:"onAttackByMelee",Slot:"head",MPCost:5,Condition:'[{"text":"繋がる総てを身に纏い、蕭然の中に在る"}]',AttackInfo:{Damage:60,AttackType:[Physical],ElementType:[None],BypassResist:false},DisableCooldownMessage:true,DisableMPMessage:true}
# セットID (int) (オプション)
