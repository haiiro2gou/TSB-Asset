#> asset:artifact/0976.brave_sword/trigger/click/slash_shot/2.main
#
#
#
# @within function asset:artifact/0976.brave_sword/trigger/click/slash_shot/1.tick
...
# ヒット判定
    execute positioned ~-0.5 ~-0.5 ~-0.5 as @e[type=#lib:living,tag=Enemy,tag=!Uninterferable,dx=0] at @s run function asset:artifact/0976.brave_sword/trigger/click/slash_shot/3.hit
