...
#
#
# @within function asset:artifact/0976.brave_sword/trigger/click/3.main
...
# 攻撃
    execute positioned ^ ^ ^1.5 as @e[type=#lib:living,tag=Enemy,tag=!Uninterferable,distance=..2] run function asset:artifact/0976.brave_sword/trigger/click/combo/damage
...
# 斬撃を飛ばす
    ...
    execute as @e[type=armor_stand,tag=R4.SlashShotInit,distance=..5,sort=nearest,limit=1] at @s run function asset:artifact/0976.brave_sword/trigger/click/slash_shot/init
    schedule function asset:artifact/0976.brave_sword/trigger/click/slash_shot/1.tick 1t replace
