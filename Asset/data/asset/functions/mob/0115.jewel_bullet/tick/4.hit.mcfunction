...
# ダメージ
    execute store result storage api: Argument.Damage double 5.0 run scoreboard players get $DamageValue Temporary
    execute if predicate api:global_vars/difficulty/max/normal run data modify storage api: Argument.Damage set value 3.0
